...
namespace Zing.Framework.UI
{
    ...
    public class GridActionAttribute : FilterAttribute, IActionFilter
    {
        ...
        public GridActionAttribute()
        {
            ...
            adapterFactory = DependencyResolver.Current.GetService<IGridActionResultAdapterFactory>();
            resultFactory = DependencyResolver.Current.GetService<IGridActionResultFactory>();
        }
