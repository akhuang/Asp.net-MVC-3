...
namespace Zing.Framework.Mvc
{
    ...
    /// </summary>
    public abstract class ModelMetadataItemBuilderBase<TItem, TItemBuilder> : IHideObjectMembers
        where TItem : ModelMetadataItemBase
        where TItemBuilder : ModelMetadataItemBuilderBase<TItem, TItemBuilder>
    {
        /// <summary>
