namespace Zing.Framework.Mvc
{
    ...
    public class StringMetadataItemBuilder : ModelMetadataItemBuilderBase<StringMetadataItem, StringMetadataItemBuilder>
    {
        ...
        private static string emailErrorMessage = TextResource.InvalidEmailAddressFormat;

        private static string urlExpression = @"(ftp|http|https)://([\w-]+\.)+[\w-]+(/[\w- ./?%&=]*)?";
        private static string urlErrorMessage = TextResource.InvalidUrlFormat;

        /// <summary>
        /// Initializes a new instance of the <see cref="StringMetadataItemBuilder"/> class.
        /// </summary>
        /// <param name="item">The item.</param>
        public StringMetadataItemBuilder(StringMetadataItem item)
            : base(item)
        {
        }
        ...
        public StringMetadataItemBuilder AsEmail()
        {
            ...
            {
                throw new InvalidOperationException(TextResource.CannotApplyEmailWhenThereIsAActiveExpression);
            }
        ...
        public StringMetadataItemBuilder AsUrl()
        {
            ...
            if (GetExpressionValidation() != null)
            {
                throw new InvalidOperationException(TextResource.CannotApplyUrlWhenThereIsAActiveExpression);
            }
